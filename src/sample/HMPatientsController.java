...
/**
 * Created by Ese on 12/19/2015.
 */
public class HMPatientsController extends VBox {
    int sum;

    @FXML
    private TextField addofkinfld;
    @FXML
    private TextField hmofld;
    ...
    public HMPatientsController() throws IOException {
        FXMLLoader fxmlloader = new FXMLLoader(AccountFormController.class.getResource("HMO.fxml"));
    ...
    void registerAction(ActionEvent event) {
        ...
        String hmo_name = hmofld.getText();

        HMOPatientBean pb = new HMOPatientBean();
