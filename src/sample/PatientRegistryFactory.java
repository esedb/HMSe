 ...
 */
public class PatientRegistryFactory {
    ...
    public PatientRegistryFactory(String firstname, String lastname,String typeofpatient, String patientserial, String dateofreg, int phonenumber)
    {
