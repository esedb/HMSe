 ...
 */
public class CompanyPatientBean implements ExecuteService{
    int sum;
    ...
    public void execute()
    {
        String sql="INSERT INTO patient_records(patient_name, dateofreg, nationality, occupation, addressofkin, phonenumber, dob, sex, " +
                ...
                "consultation_service, mortuary, nextofkin, total_cost, company_name) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try
        {
            ...
            prepstatement.setString(18, getCompanyname());
